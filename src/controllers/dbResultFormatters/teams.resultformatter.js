export default class TeamsQueryFormatter {
  static formattedTeamInformation(dbRows) {
    const { teamId, teamName, streetAddress, city, zipCode, state, country } =
      dbRows[0];
    ...
    const physiotherapists = dbRows.filter(
      (member) => member.teamRole === "Physiotherapist"
    );
